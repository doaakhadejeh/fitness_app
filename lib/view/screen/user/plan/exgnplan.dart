...
import 'package:fitnessapp/controller/controlleruser/plan/exgerplancontroller.dart';
...
class Exgnrplan extends StatelessWidget {
  const Exgnrplan({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    Get.put(Exgnrplancontroller());
    return GetBuilder<Exgnrplancontroller>(builder: (controller) {
      return Scaffold(
