import 'package:fitnessapp/controller/controlleruser/plan/privdayplancontroller.dart';
import 'package:fitnessapp/core/constant/approut.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:fitnessapp/core/class/handlingdata.dart';

class Privatdayplan extends StatelessWidget {
  const Privatdayplan({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(Privplandaycontroller());

    return GetBuilder<Privplandaycontroller>(builder: (controller) {
      return Scaffold(
