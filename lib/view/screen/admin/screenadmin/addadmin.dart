import 'package:fitnessapp/controller/controlleradmin/admincontrol/addadmincontroller.dart';
...
class AddAdmin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddAdmincontroller>(builder: (controller) {
      return Scaffold(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Text("confirm password admin",
                              style: TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 20)),
                          Container(
                            height: 5,
